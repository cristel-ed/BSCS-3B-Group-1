...
def open_admin_dashboard():
    ...
    # Title Label
    title_label = tk.Label(dashboard, text="Admin Dashboard", font=('Arial Rounded MT Bold', 30), bg='#f0f0f0')
    ...
    welcome_label = tk.Label(welcome_frame, text="Welcome, Admin", font=('Arial Rounded MT Bold', 16), bg='#ADD1FB')
    ...
    announcement_label = tk.Label(welcome_frame, text="Announcements:\n- New Evaluations Opened\n- System Maintenance Scheduled", font=('Arial', 14), bg='#ADD1FB')
    ...
    review_eval_button = tk.Button(pending_frame, text="Review Evaluations", font=('Arial Rounded MT Bold', 12), bg='#50C2C9',
                                    command=lambda: messagebox.showinfo("Evaluation", "Reviewing Evaluations..."))
    review_eval_button.pack(pady=10)
    ...
    completed_eval_label = tk.Label(completed_frame, text="Course 3 - Prof C: Reviewed on Oct 5", font=('Arial', 14), bg='#ADD1FB')
    ...
    progress_bar['value'] = 75  # Sample progress value (75%)
    progress_text = tk.Label(progress_frame, text="75% Completed", font=('Arial', 14), bg='#ADD1FB')
    progress_text.pack()

    # Course Information Frame
    course_frame = tk.Frame(main_frame, bg='#ADD1FB', bd=2, relief=tk.RIDGE)
    course_label = tk.Label(course_frame, text="Course Management", font=('Arial Rounded MT Bold', 16), bg='#ADD1FB')
    ...
    create_button(button_frame, course_icon, button_command(4), '', 'Course Management')
