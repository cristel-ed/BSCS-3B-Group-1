...
def open_adminform():
    ...
    adminButton = Button(admin, width=18, text='Submit', font=('Arial Rounded MT Bold', 8), bd=0, bg='#ADD1FB',
                         activebackground='#ADD1FB', cursor='hand2', command=admin_user)
    adminButton.place(x=95, y=376)

    signupButton = Button(admin, width=8, text='Login Here', font=('Arial Rounded MT Bold', 7), bd=0, bg='#ffffff',
    ...
    eye_button = Button(admin, image=hidePass, bd=0, bg='#ADD1FB', activebackground='#ADD1FB', cursor='hand2',
                        command=view_pass)
