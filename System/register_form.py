...
registerButton=Button(register,width=25,text='Already Have an Account ?',font=('Arial Rounded MT Bold',10),bd=0,bg='#C2C1C1',activebackground='#C2C1C1',fg='#000000',activeforeground='#000000',cursor='hand2')
